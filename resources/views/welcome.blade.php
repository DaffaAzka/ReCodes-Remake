<x-layouts.app>
    ...
    <div class="container md:mx-auto py-4 space-y-6">
        ...
        <div class="px-4 space-y-6">
            ...
            <div class="p-4 border border-gray-200 bg-white dark:border-neutral-500 dark:bg-neutral-800 dark:text-white text-center rounded-lg">
                <blockquote class="relative mx-6 my-2">
                    <svg class="absolute -top-6 -start-8 size-16 text-gray-200 dark:text-neutral-700" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
