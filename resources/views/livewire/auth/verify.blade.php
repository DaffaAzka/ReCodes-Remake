            ...
            <div
                ...
                <div class="flex items-center h-[90%]">
                    <form action="" wire:submit.prevent="login"
                        ...
                        @csrf
                        <h1 class="text-3xl text-center dark:text-amber-50 font-semibold">Enter Verification Codes</h1>


                        <div class="space-y-2">
                            <div class="relative">
                                <input wire:model='email' type="email"
                                    class="peer py-2.5 sm:py-3 px-4 ps-11 block w-full bg-gray-200 border-transparent rounded-lg sm:text-sm focus:border-purple-500 focus:ring-purple-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:border-transparent dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                    placeholder="Enter Email">
                                <div
                                    class="absolute inset-y-0 start-0 flex items-center pointer-events-none ps-4 peer-disabled:opacity-50 peer-disabled:pointer-events-none">
                                    <x-lucide-user-round class="shrink-0 size-4 text-gray-500 dark:text-neutral-500" />
                                </div>
                            </div>
